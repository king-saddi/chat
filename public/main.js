$(function() {
  ...
  var $privatenameInput = $('.privatenameInput'); // Input of private user to message to
  var $messages = $('.messages'); // Messages area
  var $inputMessage = $('.inputMessage'); // Input message input box

  var $loginPage = $('.login.page'); // The login page
  var $chatPage = $('.chat.page'); // The chatroom page
  var $lobby= $('.users.page'); // The users page
...
$window.onkeyup = function() {
  ...
  socket.on('online', function(data){
      ...
      // since it is an object, we just want the first value in the object(which is the array)
      for(var key in data){
          var online = data[key];
          break;
      }
      ...
      for(i = 0; i < online.length; i++){
        ...
        li.appendChild(document.createTextNode(online[i]));
        ul.appendChild(li);
      }
